            ...
            <div class="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                <form onsubmit="return false" class="card-body">
                    <div class="form-control">
                        ...
                        <input type="text" v-model="loginData.identifier" placeholder="username" class="input input-bordered"
                            required />
                    </div>
                    <div class="form-control">
                        <label class="label">
...
<script setup>
import { isUserLoggedIn, userData } from '~/composables/loginState';
